...
export default function App() {
  ...
  const [lang, setLang] = useState<'EN' | 'ID'>(() => {
    const saved = localStorage.getItem('nituriu_app_lang');
  ...
  const handleSetLang = (newLang: 'EN' | 'ID') => {
    setLang(newLang);
    localStorage.setItem('nituriu_app_lang', newLang);
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col justify-between font-sans antialiased selection:bg-red-500 selection:text-white">
      ...
      <div className="fixed bottom-5 right-5 z-50 flex flex-col items-end gap-2">
        ...
        <motion.a
          ...
          href="https://api.whatsapp.com/send?phone=6281236307537&text=Halo%20Nituriu%20Transport%20Bajawa,%20saya%20ingin%20konsultasi%20layanan%20sewa%20armada%20dan%20transportasi%20wisata"
          target="_blank"
          rel="noreferrer"
          ...
          title={lang === 'EN' ? "Chat with Nituriu Transport Bajawa on WhatsApp" : "Hubungi Nituriu Transport Bajawa via WhatsApp"}
        >
