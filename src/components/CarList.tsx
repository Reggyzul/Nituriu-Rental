...
export default function CarList({ onSelectCar, lang, onViewAllCars }: CarListProps) {
  ...
  const handleWhatsAppBooking = (car: Car) => {
    ...
    const message = lang === 'EN'
      ? `Hello Nituriu Travel, I am interested in renting: ${car.name}. Please inform price quote & date availability. Thank you!`
      : `Halo Nituriu Travel, saya berminat sewa armada: ${car.name}. Mohon informasi penawaran harga & ketersediaan tanggal. Terima kasih!`;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-12 space-y-3" id="cars-heading">
          <h2 className="font-display font-black text-4xl sm:text-5xl text-[#0d1b37] tracking-tight leading-tight uppercase">
            {lang === 'EN' ? 'Nituriu Travel Fleet Catalog' : 'Katalog Armada Nituriu Travel'}
          </h2>
