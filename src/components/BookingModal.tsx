...
export default function BookingModal({ car, onClose, lang, onCarChange }: BookingModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const textTemplate = isEN
      ? `Hello Nituriu Transport Bajawa, I would like to consult & reserve:
...
Please confirm availability, schedule & best rate quotes. Thank you!`
      : `Halo Nituriu Transport Bajawa, saya ingin berkonsultasi & melakukan reservasi:
            ...
            {!isBooked ? (
              ...
              <div className="py-12 text-center space-y-4">
                ...
                <p className="font-sans text-xs text-slate-600 leading-relaxed font-medium max-w-md mx-auto">
                  {isEN ? 'Thank you! You have been redirected to WhatsApp. Our team will respond immediately.' : 'Terima kasih! Anda telah terhubung langsung dengan WhatsApp Official Nituriu Travel. Tim kami akan merespons dalam hitungan menit.'}
                </p>
                <button
                  onClick={onClose}
